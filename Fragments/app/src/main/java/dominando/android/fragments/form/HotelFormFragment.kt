...
class HotelFormFragment : DialogFragment(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        edtAddres.setOnEditorActionListener {_, i, _ ->
    ...
    override fun showHotel(hotel: Hotel) {
        ...
        edtAddres.setText(hotel.address)
        rtbRating.rating = hotel.ratting
    }
    ...
    private fun saveHotel() : Hotel?{
        ...
        hotel.address = edtAddres.text.toString()
        hotel.ratting = rtbRating.rating
